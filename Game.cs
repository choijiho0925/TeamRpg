...
~~~~~~~~~~~~~~~");
        ...
        private void ShowRoyalDecree()
        {
            ...
            "뒤이어 UH-60 블랙호크 헬기대대가 하늘을 뒤덮으며 제1포병여단의 155mm 박격포가 일제히 불을 뿜는다.",
            "",
            "지축을 뒤흔드는 국군의 압도적인 화력 앞에, 던전 입구는 순식간에 초토화된다.",
            "또한 군의 기계화 보병 차량들이 전개. 보병 사단들의 물량이 던전 내부로 진입한다.",
            "",
        ...
        private void DisplayMainMenu()
        {
            ...
            "\n넓은 공터의 흉흉함 따위, 국군의 기합과 불굴의 정신력 앞에선 한낱 먼지일 뿐이다!",
            "인적이 드물었던 곳일지라도 국군이 진입하는 순간, 그곳은 대한민국의 안전한 영토로 재탄생한다.",
            "정착지 주변의 경계 태세는 그 어떤 위협도 용납하지 않는 국군의 철통같은 의지를 보여준다.",
            "잠정 통제구역 내 모든 것은 군 지휘부의 명령에 따라 움직인다. 이견은 없다.",
            "", // 공백 유지
            "여관과 상점의 민간인들은 국가를 위한 국군의 노력에 적극적으로 협조하고 있다.",
            "이 지역에 출현한 적성 세력에 대한 정보는 이미 확보되었으며, 섬멸 작전은 지체 없이 실행될 것이다.",
            "모든 군 작전은 신속하고 완벽하게 진행될 것이다.",
            "국민 여러분은 오직 안전한 일상에 집중하십시오. 국군이 모든 위협으로부터 여러분을 지킬 것입니다."
            };
